...
use crate::types::*;
    ...
    fn mount_guard_allows_only_documented_roots() {
        ...
        assert!(valid_mount("/storage/emulated/0/Android/data/com.example.app/files/cloud").is_ok());
        assert!(valid_mount("/sdcard/Android/data/com.example.app/files/cloud").is_ok());
        assert!(valid_mount("/data/media/0/Android/data/com.example.app/files/cloud").is_ok());
        assert!(valid_mount("Cargo.toml").is_err());
